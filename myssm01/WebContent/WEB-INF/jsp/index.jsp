                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" target="iframe0" href="${pageContext.request.contextPath }/sysUser/findSysUser">用户管理</a>
                            </li>
                             <li>
                                <a class="J_menuItem" target="iframe0" href="${pageContext.request.contextPath }/sysRole/findSysRole"">角色管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" target="iframe0" href="${pageContext.request.contextPath}/sysGoods/findSysGoods">商品管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem"  target="iframe0" href="${pageContext.request.contextPath}/showSysMenu">菜单管理</a>
                            </li>
                            <li>
                                <a  target="iframe0" href="${pageContext.request.contextPath}/showlog">日志管理</a>
                            </li>
                        </ul>
